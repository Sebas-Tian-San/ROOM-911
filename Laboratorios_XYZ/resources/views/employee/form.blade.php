<div class="row padding-1 p-1">
    <div class="col-md-12">
        ...
        <div class="form-group mb-2 mb20">
            <label for="internal_id" class="form-label">{{ __('Numero') }}</label>
        ...
        <div class="form-group mb-2 mb20">
            <label for="has_room_911_access" class="form-label">{{ __('Acceso al Room 911') }}</label>
        ...
        <div class="form-group mb-2 mb20">
            <label for="department_id" class="form-label">{{ __('Departamento Id') }}</label>
